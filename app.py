...
def get_polymarket():
    ...
    try:
        for offset in range(0, 200, 50):
            url = f"https://gamma-api.polymarket.com/markets?limit=50&offset={offset}"
